...
filter_gaussian_x = conv2(sobel_filter_x,conv2(sobel_filter_x,gaussian_filter,'full'),"full"); %가우시안 필터를 소벨 필터와 x방향 컨벌루션 두번 진행 (두번 미분)

filter_gaussian_y = conv2(sobel_filter_y,conv2(sobel_filter_y,gaussian_filter,'full'),"full"); %가우시안 필터를 소벨 필터와 y방향 컨벌루션 두번 진행 (두번 미분)
